...
interface UnseenChatToastProperties {
    t: Toast
    senderId:string
    sessionId:string
    senderImg:string
...
const UnseenChatToast: FC<UnseenChatToastProperties> = ({
    t, 
    sessionId, 
    senderId,
    senderImg,
  ...
  return (
    <div  
    className={
        cn('max-w-md w-full bg-white shadow-lg rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5'
